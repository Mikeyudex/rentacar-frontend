...
import type { CreateCustomerData } from "@/lib/customer-types";
import { ArrowLeft, Upload, X, FileText, User, Mail, Phone, MapPin, CreditCard } from "lucide-react"
...
export default function CustomerForm() {
  ...
  const removeFile = (
    ...
    setState({ file: null, url: "", uploading: false, progress: 0 })
    if (fieldName) {
  ...
  const onSubmit = async (data: CustomerFormData) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${data.nombres} ${data.apellidos} ha sido registrado correctamente`,
      })
          ...
          {state.uploading ? (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-green-700">{state.file?.name || "Archivo subido"}</span>
              </div>
              <Button
                type="button"
                variant="ghost"
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={isSubmitting || !contrato.url} className="min-w-[120px]">
